...
const TodoPage = () => {
  ...
  const handleAddTask = async () => {
    try {
      ...
      setTasks((prevTasks) => [...prevTasks, response.data.taskDetails]);
  ...
  return (
    <div className="w-screen h-screen flex gap-4">
      <Squares />
      <Sidebar />
      <div className="flex flex-wrap gap-4 p-10 justify-center items-center h-[100vh] w-screen">
        <div className="todo-tasks bg-white w-[60%] h-[90vh] text-black rounded-4xl flex flex-col justify-start items-center gap-4 pt-10 mt-10 p-10">
