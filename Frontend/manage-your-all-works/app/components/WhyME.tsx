...
const WhyME = () => {
  return (
    <div 
      className='w-screen h-[100vh] flex flex-col items-center justify-center z-100 gap-4 bg-black' 
      id='WHYME'
    >
      <Threads/>
      <span className='text-5xl z-100'>Why Me</span>
      <p className='w-[100%] h-max text text-center px-[20%]'>
        THIS PROJECT IS FOR THE HACKETHON SO THIS SECTION DOESN'T CONTAINS A REAL THIN IT CONTAINS ONLY EXAMPLE TEXT.
        <br />
